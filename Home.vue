<template>
  <div>
    ...
    <v-layout column justify-center align-center>
      ...
      >{{selectedCountry}}</div>
      <div v-else class="text-uppercase text--center head">covid-19 жайлы акпарат </div>
      <div
    ...
    <v-container>
            ...
            <v-card-text>
              <div class="text-center display-2">
                <v-chip color="indigo" text-color="white">
                  <v-icon>mdi-account-check</v-icon>подтвержденные
                </v-chip>
              </div>
            ...
            <v-card-text>
              <div class="text-center display-2">
                <v-chip color="pink" text-color="white">
                  <v-icon>mdi-account-convert</v-icon>активные
                </v-chip>
              </div>
            ...
            <v-card-text>
              <div class="text-center display-2">
                <v-chip color="red" text-color="white">
                  <v-icon>mdi-account-off</v-icon>смерти
                </v-chip>
              </div>
              <div class="text-center" v-if="countrySelect">
            ...
            <v-card-text>
              <div class="text-center display-2">
                <v-chip color="green" text-color="white">
                  <v-icon>mdi-account-multiple-plus</v-icon>переболевшие
                </v-chip>
              </div>
              <div class="text-center" v-if="countrySelect">
      ...
      <v-row align="center">
        <v-col>
          ...
          ></v-select>
          <div>
            <v-btn @click="reset" color="primary">сбросить</v-btn>
          </div>
          <div v-if="countrySelect" class="text-center">
            <h1 class="caption">пролистай ниже чтобы увидеть чарты</h1>
